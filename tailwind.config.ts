...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      screens: {
        "lg-1": {'min': '1024px', 'max': '1280px'},
        "md-1": {'min': '770px', 'max': '940px'},
        
      },
      boxShadow: {
        custom: "0 8px 32px 0 rgba(31, 38, 135, 0.37)",
        blurWhite: "0 0 50px white",
      },
      backdropBlur: {
        "20": "20px",
      },
      backgroundColor: {
        trancy: "rgba(0, 0, 0, 0.8)",
      },
      fontFamily: {
      ...
      keyframes: {
        ...
        "gradient-x": {
          ...
          "30%": { "background-position": "10% 30%" },
          "60%": { "background-position": "30% 60%" },
          "90%": { "background-position": "60% 90%" },
        },
        meteor: {
