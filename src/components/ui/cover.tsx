...
export const Cover = ({
  ...
  return (
    <div
      ...
      ref={ref}
      className="relative hover:bg-black bg-[#6a066d79] mt-[-10px] overflow-hidden shadow-custom backdrop-blur-20  group/cover inline-block px-[50px]  transition duration-200 rounded-tr-[50px] rounded-2xl rounded-bl-[50px]"
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
