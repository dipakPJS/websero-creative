...
export function HoverBorderGradient({
  ...
  return (
    <Link
      ...
      className={cn(
        "relative flex rounded-full border mx-auto sm:mx-auto md:mx-auto lg-1:mx-0 lg:mx-0 mt-[-40px] sm:mt-[-30px] md:mt-[-30px] lg:mt-0 content-center bg-transparent transition duration-500 items-center flex-col flex-nowrap gap-10 justify-center overflow-visible p-3 md:p-5 lg:p-7 decoration-clone w-fit",
        containerClassName
      )}
      {...props}
    >
