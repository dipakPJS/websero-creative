...
export function FlipWordsComponent() {
  ...
  return (
    <div className="text-2xl w-full text-center lg-1:text-left lg:text-left rounded-3xl sm:text-3xl md:text-3xl lg-1:text-5xl lg:text-5xl text-balance font-audioWide text-slate-300">
