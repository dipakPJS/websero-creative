...
export function FlipWordsComponent() {
  ...
  return (
    <div className="text-xl w-full text-center lg-1:text-left lg:text-left rounded-3xl sm:text-2xl md:text-6xl lg-1:text-5xl lg:text-6xl text-balance font-audioWide text-slate-300">
