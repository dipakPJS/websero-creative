  ...
  return (
    <>
      ...
      >
        ...
        <div className=" z-[10] homepage-second absolute h-full w-full flex justify-center items-center lg:mt-[-42.5px] ">
          <div className=" h-[250px] sm:h-[300px] md:h-[300px] lg-1:h-[400px] lg:h-[500px] w-auto">
            <SphereAnimation />
          </div>
        </div>
