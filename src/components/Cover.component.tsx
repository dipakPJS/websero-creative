...
export function CoverComponent() {
  ...
  return (
    <div className="pointer-events-auto">
      <h1 className="text-white flex flex-col  text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-iceBerg max-w-7xl mx-auto text-center mt-6 relative z-20 py-6 bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-700 ">
        Let&lsquo;s Get 
        <Link
